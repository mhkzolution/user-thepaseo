...
export default function PopupEditPage() {
  ...
  const handleSubmit = async () => {
    ...
    if (res.ok) router.push("/admin/popup");
    ...
    <div>
      ...
      <Card className="bg-white">
        <CardContent className="md:p-10 p-4 space-y-4">
          <h1 className="text-2xl font-bold">แก้ไข Popup</h1>

          <div className="sm:col-span-3">
            <label className="block text-sm/6 font-medium text-gray-900">ชื่อ Popup</label>
            <div className="mt-2">
          ...
          <Button className="bg-paseo" onClick={handleSubmit}>บันทึก popup</Button>
        </CardContent>
      </Card>
    </div>
  );
