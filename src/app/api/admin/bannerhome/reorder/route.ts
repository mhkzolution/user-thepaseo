...
export async function POST(req: Request) {
  try {
    ...
    console.error("Error reordering bannerhomes:", error);
    return NextResponse.json({ error: "Failed to reorder bannerhomes" }, { status: 500 });
  }
}