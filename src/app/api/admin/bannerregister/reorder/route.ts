...
export async function POST(req: Request) {
  try {
    ...
    console.error("Error reordering bannerregister:", error);
    return NextResponse.json({ error: "Failed to reorder bannerregister" }, { status: 500 });
  }
}